...
\x1b[38;5;46m /_/   \_\_| \_\___| |_/_/   \_\_| \_|                                      
  ...
  {H}     {P}[{H}•{P}] Github    : {K}github.com/ARIYAN-AHMED-143 {N}    {H}   
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     print(f'{gen}{RED}Exited {H}FB-ARIYAN {P}Terminal ');os.system("xdg-open https://www.facebook.com/FB.JEEVAN.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.JEEVAN.cyber/?ref=share');exit()
    else:
